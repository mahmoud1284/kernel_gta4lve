...
#define RA_PROX_HIGH_DIFF_CFG0_0x80         0x80
#define RA_PROX_HIGH_DIFF_CFG1_0x81         0x81
#define RA_PROX_HIGH_DIFF_CFG2_0x82         0x82
#define RA_PROX_HIGH_DIFF_CFG3_0x83         0x83
#define RA_PROX_LOW_DIFF_CFG0_0x85          0x85
#define RA_PROX_LOW_DIFF_CFG1_0x86          0x86
#define RA_PROX_LOW_DIFF_CFG2_0x87          0x87
#define RA_PROX_LOW_DIFF_CFG3_0x88          0x88
...
static struct hx9031a_addr_val_pair hx9031a_reg_init_list_hx9023e[] = {
  ...
  {RA_PRF_CFG_0x02,                  0x16}, //重要！！此处修改后要同步修改宏定义 HX9031A_ODR_MS; 0x0f:50ms
  {RA_RANGE_7_0_0x0D,                0x0c}, //range
  {RA_TEMP_SENCE_CFG_0x0F,           0x42},
  {RA_AVG0_NOSR0_CFG_0x10,           0x0f},//avg0 1 osr0 512 nwarm 64 mustbigger than 32
  {RA_NOSR12_CFG_0x11,               0x33},//osr1 osr2 512
  {RA_NOSR43_CFG_0x12,               0x00},
  {RA_AVG12_CFG_0x13,                0x00}, //avg 0
  {RA_AVG34_CFG_0x14,                0x00},
  {RA_SAMPLE_NUM_7_0_0x1f,           0x66}, //freq
  {RA_INTEGRATION_NUM_7_0_0x21,      0x66},
  {RA_SAMPLE_SWAP_CFG_0x26,          0x0F},
  {RA_LP_ALP_1_0_CFG_0x2a,           0x54},//lp alpha 1/4
  {RA_UP_ALP_1_0_CFG_0x2c,           0x55},//up alpha 1/64
  {RA_UP_ALP_3_2_CFG_0x2d,           0x55},
  {RA_DN_UP_ALP_0_4_CFG_0x2e,        0x00},
  {RA_DN_ALP_4_3_CFG_0x30,           0x00},
  {RA_DITHER_CFG_0x3C,               0x00}, //open status change IRQ
  {RA_DN_ALP_2_1_CFG_0x2f,           0x00},
  {RA_ANALOG_MOD_AMP_COMP_0x50,      0xa5},
  {RA_PROX_INT_HIGH_CFG_0x6c,        0x04},
  {RA_PROX_INT_LOW_CFG_0x6d,         0x04},
  {RA_PROX_HIGH_DIFF_CFG0_0x80,      0x04}, //ch0 near thres 128
  {RA_PROX_HIGH_DIFF_CFG1_0x81,      0x06}, //ch1 near thres 192
  {RA_PROX_HIGH_DIFF_CFG2_0x82,      0x06}, //ch2 near thres 192
  {RA_PROX_HIGH_DIFF_CFG3_0x83,      0xFF}, //ch3 near thres
  {RA_PROX_LOW_DIFF_CFG0_0x85,       0x04}, //ch0 far thres 128
  {RA_PROX_LOW_DIFF_CFG1_0x86,       0x05}, //ch1 far thres 160
  {RA_PROX_LOW_DIFF_CFG2_0x87,       0x05}, //ch2 far thres 160
  {RA_PROX_LOW_DIFF_CFG3_0x88,       0xFF} //ch3 far thres
...
static struct hx9031a_addr_val_pair hx9031a_reg_init_list_hx9031a[] = {
  ...
  {RA_GLOBAL_CTRL1_0x01,             0x82}, //open chop
  {RA_PRF_CFG_0x02,                  0x16}, //重要！！此处修改后要同步修改宏定义 HX9031A_ODR_MS; 0x0f:50ms
  {RA_RANGE_7_0_0x0D,                0x08}, //range
  {RA_TEMP_SENCE_CFG_0x0F,           0x42},
  {RA_AVG0_NOSR0_CFG_0x10,           0x13},//avg0 1 osr0 512 nwarm 64 mustbigger than 32
  {RA_NOSR12_CFG_0x11,               0x44},//osr1 osr2 512
  {RA_NOSR43_CFG_0x12,               0x00},
  {RA_AVG12_CFG_0x13,                0x00}, //avg 0
  {RA_AVG34_CFG_0x14,                0x00},
  {RA_SAMPLE_NUM_7_0_0x1f,           0x30}, //freq
  {RA_INTEGRATION_NUM_7_0_0x21,      0x30},
  {RA_SAMPLE_SWAP_CFG_0x26,          0x0F},
  {RA_LP_ALP_1_0_CFG_0x2a,           0x55},//lp alpha 1/4
  {RA_UP_ALP_1_0_CFG_0x2c,           0x55},//up alpha 1/64
  {RA_UP_ALP_3_2_CFG_0x2d,           0x55},
  {RA_DN_UP_ALP_0_4_CFG_0x2e,        0x00},
  {RA_DN_ALP_4_3_CFG_0x30,           0x00},
    {RA_CALI_DIFF_CFG_0x3b,            0x01},
  {RA_DITHER_CFG_0x3C,               0x00}, //open status change IRQ
  {RA_DN_ALP_2_1_CFG_0x2f,           0x00},
  {RA_ANALOG_MOD_AMP_COMP_0x50,      0xa5},
  {RA_PROX_INT_HIGH_CFG_0x6c,        0x01},
  {RA_PROX_INT_LOW_CFG_0x6d,         0x01},
    {RA_CAP_INI_CFG_0x6e,              0x02},
  {RA_PROX_HIGH_DIFF_CFG0_0x80,      0x04}, //ch0 near thres 128
  {RA_PROX_HIGH_DIFF_CFG1_0x81,      0x06}, //ch1 near thres 192
  {RA_PROX_HIGH_DIFF_CFG2_0x82,      0x06}, //ch2 near thres 192
  {RA_PROX_HIGH_DIFF_CFG3_0x83,      0xFF}, //ch3 near thres
...
static struct sensors_classdev sensors_capsensor_ch0_cdev = {
    ...
    .vendor = "TianYiHeXin",
    .version = 1,
    .type = SENSOR_TYPE_TYHX_CAPSENSE,
    .max_range = "5",
    .resolution = "5.0",
    .sensor_power = "3",
    .min_delay = 0,
