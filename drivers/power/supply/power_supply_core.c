				  ...
				  struct power_supply_battery_info *info, int num)
{
	...
	//bug696110,tankaikun.wt,mod,2022/08/08,add bat protect
	if (strcmp("P15945-FEIMAOTUI-6800mah-4400", value) &&
			strcmp("P15945-FEIMAOTUI-6800mah-4368", value) &&
			strcmp("P15945-FEIMAOTUI-6800mah-4336", value) &&
			strcmp("P15945-FEIMAOTUI-6800mah-4304", value) &&
			strcmp("P15945-FEIMAOTUI-6800mah-4272", value))
		return -ENODEV;
